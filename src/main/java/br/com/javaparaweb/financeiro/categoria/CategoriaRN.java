...
public class CategoriaRN {
	...
	public void replicarFator(Categoria categoria, int fator){
	...
	public void salvaEstruturaPadrao(Usuario usuario){
		...
		this.categoriaDAO.salvar(new Categoria(despesas, usuario, "Salário", 1));
		this.categoriaDAO.salvar(new Categoria(despesas, usuario, "Restituições", 1));
		this.categoriaDAO.salvar(new Categoria(despesas, usuario, "Rendimento", 1));
	}
}
